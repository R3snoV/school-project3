		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td>د,م<?php echo $fetch_cart['price']; ?>/-</td>
					<td class="quantity">
						<form method="post">
					...
					<td>د,م<?php echo $sub_total = $fetch_cart['price'] * $fetch_cart['quantity']; ?></td>
				...
				<tr class="table-bottom">
					...
					<td style="font-weight: bold;">د,م<?php echo $grand_total; ?></td>
